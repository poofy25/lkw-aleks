    ...
    return ( 
        <section id='desprenoi' className={styles.about}>
                ...
                <section className={styles.textSection}>
                    ...
                    <span><img src={checkbox}/>Soluții logistice fiabile și flexibile</span>
                    <span><img src={checkbox}/>Echipă de profesioniști dedicată</span>
                    <span><img src={checkbox}/>Punctualitate și costuri competitive</span>
